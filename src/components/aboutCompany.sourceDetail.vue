<template>
  <div id="aboutCompany">
    <div class="company-logo">
      <img src="../assets/images/company-img.png" height="256" width="256" alt="company logo">
    </div>
    <div class="infos">
      <div class="row company-name">
        <h3>{{ this.getCompany.name }}</h3>
      </div>
      <div class="row working-hours">
        ...
        <h3>{{ this.getCompany.startingHour }}:00 - {{ this.getCompany.endingHour }}:00 ({{ this.getCompany.workingDays }})</h3>
      </div>
      <div class="row phone">
      ...
      <div class="row company-address">
        ...
        <h3>{{ this.getCompany.address }} {{ capitalizeFirstLetter(this.getCompany.neighborhood) }} {{ capitalizeFirstLetter(this.getCompany.province) }}  {{this.getCompany.postalcode}} {{ this.getCompany.city }}, Turkey</h3>
      </div>
    </div>
  </div>
</template>
...
export default {
  name: 'aboutCompany.sourceDetail.vue',
  router,
  data: function () {
    return {
      sourceId: '',
